      ...
      <nav className="reverse-row">
        <ul className="reverse-row space-between align-right">
            ...
            .map(name => {
              ...
              return (
                <li key={name} className="fill-up">
                  {connected && (
                    <div
                      className={`btn btn-${color} ${color} fill-up cursorNormal`}>
                      <FaCheckCircle
                        className="green"
                        size={30}
                        style={{
                      ...
                      />
                      {account ? (
                        <CopyableShortAccount account={account} />
                      ) : (
                        "Connected"
                      )}
                    </div>
                  ...
                  {!connected && (
                    <button
                      ...
                      {activating && (
                        <Spinner color={"black"} style={{ height: "75%" }} />
                      )}
                      connect to {name}
                    </button>
                  )}
          ...
          {active && (
            <li className="fill-up">
              <button
                className="btn btn-violet violet fill-up"
                onClick={onClickShowWalletInfo}>
                <FaWallet
                  className="violet"
                  size={20}
          ...
          {!!error && (
            <li className="fill-up">
              <div
                className="btn btn-clear fill-up cursorNormal"
                style={{
                  maxWidth: "2000px"
                }}>
